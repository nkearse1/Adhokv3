...
function TalentProjectDetail() {
  ...
  useEffect(() => {
    const fetchProject = async () => {
      if (USE_MOCK_SESSION && id === 'mock-project-id') {
        setProject({
          id: 'mock-project-id',
          title: 'Mock SEO Optimization',
          description: 'Audit and improve on-page performance for a small business website.',
          talent_id: 'mock-talent-id',
          status: 'submitted',
          client_review: null,
          ...
          metadata: {
            ...
            marketing: {
              ...
              deliverables: 'Technical audit report, Content strategy document',
              problem: 'Low organic traffic and poor search rankings',
              target_audience: 'B2B SaaS companies',
              platforms: 'WordPress, Google Search Console',
              preferred_tools: 'Ahrefs, Screaming Frog',
              brand_voice: 'Professional and authoritative',
              inspiration_links: 'https://example1.com, https://example2.com'
            }
          },
          brief_url: 'https://example.com/brief.pdf',
          category: 'SEO & Content',
          minimum_badge: 'Expert Talent'
        });

        setTalentProfile({
          full_name: 'Mock Expert User',
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex gap-3">
        <Button
          onClick={() => navigate(`/talent/projects/${id}/workspace`)}
